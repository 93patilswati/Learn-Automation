...
public class ValidLoginTestCase {
	...
	public static void main(String[] args) throws InterruptedException, EncryptedDocumentException, IOException {
		...
		FileInputStream fis = new FileInputStream("./data/FacebookTestData.xlsx");
		...
		FileInputStream fis2 = new FileInputStream("./data/FacebookTestData.xlsx");
		...
		Thread.sleep(2000);
		driver.findElement(By.id("u_0_5_s4")).click();
	
		
		//driver.findElement(By.id("pass")).sendKeys(flib.readExcelData("./data/FacebookTestData"));
